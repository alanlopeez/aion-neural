        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-2 sm:pb-0 w-full sm:w-auto">
          {categories.map((cat) => {
            ...
            return (
              <Link
                key={cat}
                href={cat === "Todas" ? "/blog" : `/blog?categoria=${encodeURIComponent(cat)}`}
          ...
          <div className="grid grid-cols-1 gap-5">
            {questions.map((question) => {
              ...
              return (
                <div
                  key={question.id}
                  className="group relative rounded-3xl p-5 sm:p-8 bg-zinc-950/80 border border-zinc-800/80 hover:border-teal-500/40 transition-all duration-300 space-y-4 hover:shadow-2xl shadow-zinc-950"
                >
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-4 border-t border-zinc-900">
                    ...
                    <Link
                      ...
                      className="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-full bg-zinc-900 hover:bg-teal-500/20 text-zinc-200 hover:text-teal-300 border border-zinc-800 hover:border-teal-500/40 text-xs font-semibold transition-all group-hover:translate-x-0.5 active:scale-95"
                    >
